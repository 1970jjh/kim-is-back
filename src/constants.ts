...
export const EVENTS = [
  {
    ...
    label: '휴게시간',
    image: 'https://i.ibb.co/VYgjPNH9/event1.jpg',
    instruction: ''
  },
  {
    type: EventType.LUNCH,
    label: '점심시간',
    image: 'https://i.ibb.co/B2PhHKbp/event2.jpg',
  ...
  },
  {
    ...
    label: '협찬활동',
    image: 'https://i.ibb.co/Zpxfgmfh/event10.jpg',
