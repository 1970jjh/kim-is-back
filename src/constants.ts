...
export const EVENTS = [
  {
    ...
    label: '휴게시간',
    image: 'https://i.ibb.co/twHvbgmb/33.jpg',
    instruction: ''
  },
  {
    type: EventType.LUNCH,
    label: '점심시간',
    image: 'https://i.ibb.co/LfN3pjx/2.jpg',
  ...
  },
  {
    ...
    label: '협찬활동',
    image: 'https://i.ibb.co/bj5B6z3Z/33.jpg',
