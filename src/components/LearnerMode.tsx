...
const R6_STORY = "R6: [추리] 사라진 카드를 찾아라 (1급 기밀 추적)\n5월의 훈훈했던 단합도 잠시, 6월의 무더위와 함께 본사 발 '1급 기밀 첩보'가 날아들었다. \"인사권을 쥔 상무님의 행방을 확보하라!\" 하지만 보안 유지를 위해 결정적 단서는 6장의 '트럼프 카드'로 쪼개져 강의장 곳곳에 은밀하게 숨겨졌다. 가만히 앉아 있는 자에게 동아줄은 내려오지 않는 법. 지금 바로 팀원 모두가 '명탐정'의 눈으로 강의장 구석구석을 샅샅이 뒤져 숨겨진 카드를 찾아 사진을 찍고, 다시 그 자리에 숨겨둬야한다. 6장의 카드를 모두 찾았다면, 조각난 단서들을 조합해 상무님이 출장을 떠난 '도시명'을 찾아내라!";
