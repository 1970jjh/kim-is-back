...
// Gemini 2.0 Flash - 텍스트 분석 및 종합 리포트 생성 (안정적인 모델 사용)
const GEMINI_PRO_TEXT_URL = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent';
...
반드시 JSON 형식으로만 응답해주세요.`;
  ...
  try {
    console.log('Calling Gemini 2.0 Flash for total performance analysis...');
